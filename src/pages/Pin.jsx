...
const schema = yup.object().shape({
  pin: yup
    .string()
    .matches(/^\d{6}$/, "PIN must be exactly 4 digits")
  ...
  return (
    <div className="pin">
      ...
      <div className="contentSec">
          ...
          <div className="title">Verify email or 2FA</div>
          <div className="subText">Please enter the 6-digit code we've sent to your Email</div>
        </div>
